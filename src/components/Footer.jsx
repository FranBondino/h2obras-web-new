...
export default function Footer() {
    return (
        <footer className="bg-slate-100 dark:bg-slate-900 w-full border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="max-w-7xl mx-auto px-12 pb-8 border-t border-slate-200 dark:border-slate-800 pt-8 flex justify-between items-center">
                <p className="font-['Inter'] text-[10px] tracking-widest text-slate-400 uppercase">
                    © 2024 H2O OBRAS - Sovereign Infrastructure Engineering
                </p>
                <div className="flex gap-4">
                    <div className="w-8 h-8 rounded-sm bg-cyan-950 dark:bg-white flex items-center justify-center">
